        ...
        <div className="container">
          ...
          <div className={rushStyles.faq__item}>
            ...
            <p>
              ...
              multiple events that will give you a taste of what our fraternity
              stands for, whether you are a good fit for us, and whether we are
              a good fit for you. At the end of rush, we extend a limited number
              of interviews and bids. Those who receive bids can then decide
              whether or not they would like to pledge. Rushing is completely
              free of charge and there are no obligations.
            </p>
          </div>
          <div className={rushStyles.faq__item}>
            ...
            <ul>
              ...
              <li>
                Must have at least 2 semesters remaining at SJSU (one to pledge
                and one to be an active brother)
              </li>
            </ul>
          </div>
          <div className={rushStyles.faq__item}>
            ...
            <p>
              ...
              benefits socially, professionally, and academically. Theta Tau is
              a diverse group of engineers who grow close together while
              striving towards similar goals. We believe that joining an
              organization in which we can build lasting friendships, hone our
              engineering and leadership skills, and give back to our community
              will contribute to our growth as individuals both in our
              professional and personal lives. We are committed to fostering a
              welcoming, safe, and social environment, and we invite you to join
              us!
            </p>
          </div>
          <div className={rushStyles.faq__item}>
            ...
            <p>
              ...
              potential candidates to attend as many events as possible in order
              for them to get to know the Chapter better and vice versa.
            </p>
          </div>
          <div className={rushStyles.faq__item}>
            <h1>Q: What is Pledging?</h1>
            <p>
              Pledging is a semester long process in which you will be given the
              opportunity to show your character, skills, and leadership to the
              SJSU Chapter of Theta Tau. You and your pledge class will be given
              a set of tasks to execute, each of which embodies the 3 pillars of
              Theta Tau. The goals of assigning these tasks are to develop
              critical academic and profesional skills critical to one's career,
              as well as engage pledges in long-lasting brotherhood.
            </p>
          </div>
          <div className={rushStyles.faq__item}>
          ...
          <div className={rushStyles.faq__item}>
            ...
            <p>
              Yes! Oftentimes, it is the case that we have an abundance of great
              potential members, and cannot extend bids to as many members as we
              would like. We highly encourage that those who do not receive bids
              to come back and rush again the following semester.
            </p>
          </div>
        </div>
      </div>
